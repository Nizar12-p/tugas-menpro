...
?>
                            ...
                            <table id="datatablesSimple">
                                ...
                                <tbody>
                                <?php
                                $ambilsemuastok = mysqli_query($conn, "select * from stok");
                                $i = 1;
  ...
  <div class="modal-body">
    ...
    <input type="text" name="namabarang" placeholder="namabarang" class="form-control"require>
    <br>
    ...
    <br>
    <button type="submit" class="btn btn-primary" name="addnewbarang">Kirim</button>
  </div>
</form>
