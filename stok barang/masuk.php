  ...
  Tambah barang
                            ...
                            <div class="card-body">
                                <table id="datatablesSimple">
                                    ...
                                    <?php
                                    $ambilsemuastok = mysqli_query($conn,"select * from masuk m,stok s where s.idbarang=m.idbarang");
...
<div class="modal fade" id="myModal">
  ...
  <div class="modal-body">
    ...
    <br>
    <button type="submit" class="btn btn-primary" name="barangmasuk">Kirim</button>
  </div>
</form>
